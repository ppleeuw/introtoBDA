...
**Your Answers here:**
<br>1.: at "\nDownloading ticker AAPL ...", sourced from dataSet1.r
<br>2: Cumulative return = round(100*sum(StockReturns[,2]),2) = 595.49
<br> Average daily return = round(100*mean(StockReturns[,2]),3) = 0.148
<br> Standard Deviation = round(100*sd(StockReturns[,2]),3) = 2.39

<hr>3: yes, by adjusting the dataset1.R file and adding "YHOO" to mytickers = c("SPY", "AAPL") and rerun the previous process
<hr>
...
**Your Answers here:**
<br>1: change to startDate = "2001-01-01" (was already there in the file though, so no need to change)
<br>2: add companies to mytickers = c("SPY", "AAPL", "TSLA") and change startdate
<br>
<br>
...
**Your Answers here:**
<br>1: this gives the nuber of instances in which myData is not equal to StockReturns[1:20] = 20
<br>2: both vectors will be added to each other
<br>
<br>
